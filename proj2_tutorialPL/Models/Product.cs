...
namespace proj2_tutorialPL.Models
{
    public class Product
    {
        ...
        [Required(ErrorMessage = "Pole spalanie jest wymagane:")]
        ...
        // PicturePath is now optional
        public string? PicturePath { get; set; } // Use nullable string to indicate it's optional
    }
}
